...
pair<int, int> getTotals(const vector<string>& hand) {
    string c1, v1;
...
string outputScore(const vector<string>& hand) {
    ...
    pair <int, int>total = getTotals(hand);
    int total2 = total.first;
    int total1 = total.second;
...
string getAdvice(const vector<string>& playerHand, string dealerCard) {
    ...
    pair <int, int>total = getTotals(playerHand);
    int total2 = total.first;
    int total1 = total.second;
